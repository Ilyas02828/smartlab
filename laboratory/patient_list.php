...
<div class="card-header bg-info">
    <h4 class="mb-0 text-white">ALL PATIENT LIST</h4>
</div>
...
<table class="table table-striped table-bordered table-hover" id="example1">
	...
	<tbody>
		<?php
		$counter=0;
    $query1=mysqli_query($connection,"SELECT p_id FROM result ORDER BY created_at DESC");
while ($row1=mysqli_fetch_array($query1)) {
$oldpatient_id=$row1['p_id'];
}
$query=mysqli_query($connection,"SELECT * FROM patient WHERE id != $oldpatient_id  ORDER BY created_at DESC");
