...
<?php include 'includes/sidebar.php'; ?>
    ...
    <h4 class="mb-0 text-white">ALL PATIENT DUES HISTORY</h4>
</div>
<div class="card-body">
...
$fetch ="SELECT  patient.name,patient_payment_history.total, GROUP_CONCAT(patient_payment_history.paid) AS PPaid,GROUP_CONCAT(patient_payment_history.dues) AS PDues, patient_payment_history.id,patient_payment_history.p_id,
